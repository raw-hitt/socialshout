                ...
                <Card className="editCard">
                    <CardActionArea>
                        ...
                        <CardContent className="edit-Card">
                            ...
                            <div>
                                <TextField type="password"  label="current password" id="current_password"  />
                            </div>
                            <div>
                                <TextField type="password"  label="new password" id="new_password"  />
                            </div>
                            <div>
                                <TextField type="password"  label="confirm password" id="confrim_password"  />
                            </div>
                        </CardContent>
                    </CardActionArea>
                    <CardActions className="edit-Card">
                        <div>
                            ...
                            <Button size="small" color="secondary" component={Link} to="/edit">Cancel</Button>
                        </div>
                    </CardActions>
                </Card>
            </div >
